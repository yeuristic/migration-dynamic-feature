...
object ReplaceRPattern {
    ...
    inline fun replaceRPattern(input: String, newPrefix:String, replaceableBlock: (ResourceData) -> Boolean): String? {
        ...
        val rPattern = Pattern.compile("(?<![\\.a-zA-Z0-9_])R$spacingAndCommentRegex\\.$spacingAndCommentRegex([a-zA-Z0-9_]+)$spacingAndCommentRegex\\.$spacingAndCommentRegex([a-zA-Z0-9_]+)")
